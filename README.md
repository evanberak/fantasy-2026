...
## v0.4.0 changes
- Reworked the visual design into a more premium phone-first app style with glassmorphism cards, stronger spacing, and more polished surfaces.
- Added more expressive typography using a more modern headline/body font pairing.
- Removed all table/dataframe UI from the app. Lists now render as mobile-friendly cards instead of grids.
- Updated draft board, best available players, standings, power rankings, waivers, injury report, roster review, player compare, screenshot matches, and simulation summaries to use card-based layouts.
- Kept the cleaner tap targets, CPU personalities, Get Latest Version, and season save/import workflow from earlier versions.
